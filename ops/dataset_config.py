...
ROOT_DATASET = '/home/comp/cszsliu/tmh_wardvideo/'  # '/data/jilin/'


def return_ucf101(modality):
    filename_categories = 'UCF-img/labels/classInd.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'UCF-img/jpg'
        filename_imglist_train = 'UCF-img/file_list/ucf101_rgb_train_split_1.txt'
        filename_imglist_val = 'UCF-img/file_list/ucf101_rgb_val_split_1.txt'
        prefix = 'img_{:05d}.jpg'
    elif modality == 'Flow':
...
def return_tmh(modality):
    filename_categories = 4
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'imgSide'
        filename_imglist_train = 'imgSide/labels/tmh_rgb_train_split_1.txt'
        filename_imglist_val = 'imgSide/labels/tmh_rgb_val_split_1.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics, 'tmh': return_tmh}
